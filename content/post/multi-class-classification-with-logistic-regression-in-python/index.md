...
$y$, our classification, can be either 1 or 0. Because of the $\log$ in this cost function, a prediction matching the classification will have a cost of 0, but approach infinity as the prediction approaches the wrong classification.
